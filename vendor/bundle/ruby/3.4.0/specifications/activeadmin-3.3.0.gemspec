...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<arbre>.freeze, ["~> 1.2".freeze, ">= 1.2.1".freeze])
  s.add_runtime_dependency(%q<csv>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<formtastic>.freeze, [">= 3.1".freeze])
  s.add_runtime_dependency(%q<formtastic_i18n>.freeze, [">= 0.4".freeze])
  s.add_runtime_dependency(%q<inherited_resources>.freeze, ["~> 1.7".freeze])
  s.add_runtime_dependency(%q<jquery-rails>.freeze, [">= 4.2".freeze])
  s.add_runtime_dependency(%q<kaminari>.freeze, [">= 1.2.1".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, [">= 6.1".freeze])
  s.add_runtime_dependency(%q<ransack>.freeze, [">= 4.0".freeze])
end
